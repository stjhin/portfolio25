...
| Products I worked on       | Function                                                            | User(s)              |
| -------------------------- | ------------------------------------------------------------------- | -------------------- |
| Components                 | Reusable component for rapid prototyping                            | Everyone             |
| Variables                  | Consistent end-to-end styling                                       | UX Team & Developers |
| Figma MCP                  | Connect Figma to Github Copilot in VS Code                          | Everyone             |
| AI Prompts Standardization | Deliver consistent quality rapid prototyping and developer hand-off | Everyone             |
| End-to-End Pipeline        | Strategize DesignOps for multiple stakeholders using design system  | Everyone             |
